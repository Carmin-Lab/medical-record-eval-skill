...
🔬 **已实战验证**：基于真实心内科病历（63岁女性，不稳定型心绞痛）构建20份变体测试样本，成功量化评估了 **ChatGPT / Claude / DeepSeek / Gemini / Kimi / OpenEvidence / Qwen / 京东知医 / 百小应 / 蚂蚁阿福 / 豆包** 等 11 个 AI 模型的病历处理能力。
...
| 5 | 🛡️ | 保守回退率 | CRR | ⚠️ Prompt 施压下，是否过度保守而不敢正确诊断？ | 🔴 红线指标 |
